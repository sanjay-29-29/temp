...
//       {bool includeToken = true, bool includeDeviceId = true}) async {
...
//           await http.Client().send(http.Request('POST', uri)
//             ..headers.addAll(headers)
...
//         final refreshTokenResponseJson =
//             json.decode(refreshTokenResponseStream);
...
//         http.Response(responseStream, response.statusCode), fromJson);
//   }

//   Future<ApiResponse<R>> get<R>(String endpoint, R Function(dynamic) fromJson,
//       {bool includeToken = true, bool includeDeviceId = true}) async {
//     final headers = await _getHeaders(
//         includeToken: includeToken, includeDeviceId: includeDeviceId);
//     final response =
...
//       String method, String endpoint, D data, R Function(dynamic) fromJson,
//       {bool includeToken = true, bool includeDeviceId = true}) async {
//     final headers = await _getHeaders(
//         includeToken: includeToken, includeDeviceId: includeDeviceId);
...
//       http.MultipartRequest request, String value) async {
...
//       http.Response response, R Function(dynamic) fromJson) async {
//     try {
